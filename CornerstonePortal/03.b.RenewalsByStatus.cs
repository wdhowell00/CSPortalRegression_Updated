...
namespace CornerstonePortal
{
    ...
    public class RenewalsByStatus
    {
        ...
        [TestMethod]
        public void RenewalsByStatusTest()
        {
            Login();
            Navigation();
            RenewalStatusValidation();
            Logout();
        }
        ...
        void RenewalStatusValidation()
        {
            ...
            Thread.Sleep(1000);
            Assert.AreEqual("ui fitted large teal history icon", BaseTest.Driver.FindElement(By.XPath("//*[@id='listView']/div/div[2]/table/tbody/tr[10]/td[4]/div/i")).GetAttribute("class"));
            ...
            Assert.AreEqual("Debt Collection License Or Registration", BaseTest.Driver.FindElement(By.XPath("(.//*[normalize-space(text()) and normalize-space(.)='()'])[1]/following::td[1]")).Text);
            Thread.Sleep(1000);
            Assert.AreEqual("ui fitted large yellow wait icon", BaseTest.Driver.FindElement(By.XPath("//*[@id='listView']/div/div[2]/table/tbody/tr[10]/td[4]/div/i")).GetAttribute("class"));
            ...
            // Validate "Submitted and at State status"
            BaseTest.Driver.FindElement(By.XPath("(.//*[normalize-space(text()) and normalize-space(.)='Status'])[1]/following::i[1]")).Click();
            BaseTest.Driver.FindElement(By.XPath("//*[@id='dashbdFilters']/div[1]/div/div[2]/div[4]")).Click();
            BaseTest.Driver.FindElement(By.XPath("(.//*[normalize-space(text()) and normalize-space(.)='()'])[1]/following::td[1]")).Click();
            Assert.AreEqual("Certificate of Authority", BaseTest.Driver.FindElement(By.XPath("//*[@id='listView']/div/div[2]/table/tbody/tr[2]/td[2]")).Text);
            Thread.Sleep(1000);
            Assert.AreEqual("ui fitted large blue send icon", BaseTest.Driver.FindElement(By.XPath("//*[@id='listView']/div/div[2]/table/tbody/tr[2]/td[4]/div/i")).GetAttribute("class"));
            Console.Write("Submitted and at State Status Successful");
