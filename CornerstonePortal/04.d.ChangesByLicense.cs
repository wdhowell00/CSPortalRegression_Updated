...
namespace CornerstonePortal
{
    ...
    public class ChangesByLicense
    {
        ...
        [TestMethod]
        public void ChangesByLicenseTest()
        {
            Login();
            Navigation();
            LicenseValidation();
        ...
        void LicenseValidation()
        {
            ...
            BaseTest.Driver.FindElement(By.XPath("(.//*[normalize-space(text()) and normalize-space(.)='Filter by License Types'])[1]/following::div[2]")).Click();
            BaseTest.Driver.FindElement(By.XPath("(.//*[normalize-space(text()) and normalize-space(.)='Certificate of Authority'])[2]/following::div[1]")).Click();
            ...
            Assert.AreEqual("Debt Collection License Or Registration", BaseTest.Driver.FindElement(By.XPath("(.//*[normalize-space(text()) and normalize-space(.)='(Primary location)'])[2]/following::td[1]")).Text);
        }
    }
}
